...
namespace RimworldModReleaseTool
{
    ...
    public class ReleaseSettings
    {
        ...
        [XmlElement(ElementName = "patronsMessage")]
        public string PatronsMessage { get; set; }

        [XmlElement(ElementName = "patronsFilePath")]
        public string PatronsFilePath { get; set; }
        
        [XmlElement(ElementName = "askForVersionNum")]
        public bool AskForVersionNum { get; set; }
        
        [XmlElement(ElementName = "autoGenerateChangelog")]
        public bool autoGenerateChangelog { get; set; }
        
        [XmlElement(ElementName = "autoGenerateDescription")]
